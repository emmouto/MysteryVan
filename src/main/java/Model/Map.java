...
public class Map {
    ...
    private void init(String name) {
        switch (name) {
            case "mapHard" :   platforms.add(new Platform(0,96,48,160));
            ...
            case "mapEasy" :   platforms.add(new Platform(0,96,48,160));
                            platforms.add(new Platform(480,96,48,160));
                            platforms.add(new Platform(192,192,16,288));
                            platforms.add(new Platform(0,320,16,640));
            case "mapMedium" :   platforms.add(new Platform(0,96,48,160));
                            platforms.add(new Platform(480,96,48,160));
